...
try:
    ...
    if save_btn:
        print("Clicking Save to Reports...")
        ...
        try:
            ...
            print("No alert or error dismissing it:", e)
        
    go_client("/reports")
    print("--- Reports Page Content ---")
    print(driver.find_element(By.TAG_NAME, "body").text[:2000])
    
    print("\nButtons on Reports Page:")
    for b in driver.find_elements(By.TAG_NAME, "button"):
        print(f"  text='{b.text}' class='{b.get_attribute('class')}' HTML='{b.get_attribute('outerHTML')}'")
